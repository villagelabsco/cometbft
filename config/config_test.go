...
func TestConsensusConfig_ValidateBasic(t *testing.T) {
	...
	testcases := map[string]struct {
		...
		"TargetHeightDuration":                 {func(c *config.ConsensusConfig) { c.TargetHeightDuration = time.Second }, false},
		"TargetHeightDuration negative":        {func(c *config.ConsensusConfig) { c.TargetHeightDuration = -1 }, true},
		"PostTargetBufferDuration":             {func(c *config.ConsensusConfig) { c.PostTargetBufferDuration = time.Second }, false},
		"PostTargetBufferDuration negative":    {func(c *config.ConsensusConfig) { c.PostTargetBufferDuration = -1 }, true},
